      ...
      <div className="card mt-2">
        <div className="card-body">
          ...
          <article className="col-lg-6">
            <div>
              <p>Mood</p>
              <img src="./Assets/Images/Mood.png" alt="Mood Project" className="img-thumbnail"/>
            ...
            <div>
              ...
              <img src="./Assets/Images/Planner.png" alt="Workday Scheduler thumbnail" className="img-thumbnail"/>
            ...
            <div>
              ...
              <img src="./Assets/Images/PassGen.png" alt="Password Generator thumbnail" className="img-thumbnail"/>
